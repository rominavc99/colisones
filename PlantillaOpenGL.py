...
def chechar_colisiones():
    global colisionando
    #si extrema derecha carrito es mayor que extrema izquierda obstaculo
    #y extremaizquierda de carrito es menor que extrema derecha obstaculo
...
def dibujarObstaculo():
    ...
    glVertex(-0.15, 0.15, 0.0) #izquierda
